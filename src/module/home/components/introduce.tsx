    ...
    <div className="relative w-full py-12 md:py-20 lg:py-38 bg-[#f5f5f5]">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-start">
          ...
          {/* Left Card - Kim Ngan */}
          <div className="lg:col-span-3 flex flex-col items-center lg:items-start text-center">
          ...
          <div className="lg:col-span-6 flex justify-center order-first lg:order-0">
          ...
          <div className="lg:col-span-3 flex flex-col text-center items-center lg:items-end lg:self-end">
            ...
            <div className="relative w-full max-w-[280px] aspect-3/4 overflow-hidden shadow-lg shine-on-hover lg:order-last">
              <Image
