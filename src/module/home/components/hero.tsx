  ...
  return (
    <section className="relative h-[400px] md:h-[600px] lg:h-[833px] max-w-[1730px] px-2 mx-auto overflow-hidden ">
      <div className="relative h-full">
        ...
        <h2 className="hidden lg:block absolute z-10 right-[10px] 2xl:right-[350px] bottom-0 font-medium mb-0 ml-2 leading-[400px]" aria-label="AFTER" style={{ perspective: '1500px' }}>
          <div
            aria-hidden="false"
            className="relative block text-start text-black font-felidae text-[200px] 2xl:text-[290px]"
            style={{
      ...
      {/* Right Image */}
      <motion.div
        className="absolute right-0 md:right-[-20px] lg:right-[-50px] top-0 w-full lg:w-1/2 h-full z-0"
      ...
      >
        <div className="relative w-full h-full">
          <Image
            ...
            className="object-cover object-center md:object-center opacity-30 md:opacity-60 lg:opacity-100"
            priority
            quality={95}
          />
        </div>
